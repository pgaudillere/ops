...
//Include ops
#include <ops.h>
//Include a publisher for the data type we want to publish, generated from our IDL project HelloRequestReply.
#include "hello/RequestHelloDataPublisher.h"
//Include type support for the data types we have defined in our IDL project, generated from our IDL project HelloRequestReply.
...
int main(int argc, const char* args[])
{
	...
	Topic topic = participant->createTopic("RequestHelloTopic");

	//Create a publisher on that topic
	hello::RequestHelloDataPublisher pub(topic);
	pub.setName("RequestHelloTopicPublisher"); //Optional identity of the publisher
